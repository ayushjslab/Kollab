...
export const Profile = ({ memberId, onClose }: ProfileProps) => {
  ...
  const { data: currentMember, isLoading: isLoadinCurrentMember } =
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center p-4">
          <Avatar className="max-w-[200px] max-h-[200px] size-full">
            ...
            <AvatarFallback className="rounded-md bg-gradient-to-r from-indigo-500 to-purple-500  text-white aspect-square text-6xl">
              {avatarFallback}
            </AvatarFallback>
          </Avatar>
        </div>
